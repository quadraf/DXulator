...
DXulator is engined by Csound and fueled with the 32 orc's (credits for Dr. Russell Pinkston, 
Jeff Harrington and Sylvain Marchand ) found  here  on Jeff's site,
which describe the algoritms in a DX7 synthesizer. 
The main purpose is to automaticaly create and play SFZ  soundfont  files from DX7 patches.
Secondarily  DXulator is also a DX7 editor/patchmanager.
